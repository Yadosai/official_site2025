<template>
    ...
    <div class="QAcontainer">
        <item question="開催日はいつですか？" answer="今年度は5月30日が前夜祭で5月31日が本祭になっております" />
        ...
        <item question="雨天時はどうなりますか？" answer="前夜祭につきましては、当日の14時ごろに、本祭につきましては当日の午前７時ごろに実施の可否を判断しお知らせする予定です。何卒ご理解とご協力のほど、よろしくお願い申し上げます。" />
    </div>
</template>
